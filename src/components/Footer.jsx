      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-4 pt-2">
            <span className="h-8 w-8 rounded-lg bg-gray-900 flex items-center justify-center text-white text-xs font-bold cursor-pointer hover:bg-indigo-600 transition-colors">Fb</span>
            <span className="h-8 w-8 rounded-lg bg-gray-900 flex items-center justify-center text-white text-xs font-bold cursor-pointer hover:bg-indigo-600 transition-colors">Ig</span>
            <span className="h-8 w-8 rounded-lg bg-gray-900 flex items-center justify-center text-white text-xs font-bold cursor-pointer hover:bg-indigo-600 transition-colors">Tw</span>
          </div>
        </div>
